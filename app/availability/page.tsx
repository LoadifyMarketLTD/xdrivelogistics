    ...
    <div className="dashboard-content">
      ...
      <main className="container">
        <section style={{ marginTop: '32px' }}>
          <h1 className="section-title" style={{ fontSize: '28px', marginBottom: '16px' }}>🔴 Live Availability</h1>
          <p style={{ color: '#94a3b8', fontSize: '15px', marginBottom: '32px' }}>Real-time vehicle availability</p>
          <div style={{ backgroundColor: '#132433', borderRadius: '12px', padding: '60px 40px', textAlign: 'center', border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '15px', lineHeight: '1.6', maxWidth: '500px', margin: '0 auto 24px' }}>Live Availability tracking is under development.</p>
