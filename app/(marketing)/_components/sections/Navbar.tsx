    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontSize: '1.5rem', fontWeight: 800, color: '#D4AF37', letterSpacing: '-0.5px' }}>X</span>
            <span style={{ fontSize: '1.1rem', fontWeight: 700, color: isLight ? '#1F3A5F' : '#FFFFFF', transition: 'color 0.3s ease' }}>
              Drive Logistics
            </span>
          </a>
        ...
        {menuOpen && (
          <nav aria-label="Mobile navigation" style={{ backgroundColor: '#FFFFFF', borderTop: '1px solid rgba(31,58,95,0.1)', padding: '1rem 24px 1.5rem' }}>
            {NAV_LINKS.map((link) => (
              <a
                key={link.label}
                href={link.href}
