    ...
    const checkAuth = async () => {
      ...
      if (session) {
        ...
        const isActive = profileData?.status === 'active' ||
          (!profileData?.status && profileData?.is_active !== false)

        if (!isActive) {
          router.push('/pending')
        } else {
          router.push(getDefaultDashboardPath(profileData?.role))
        }
      } else {
        setChecking(false)
      }
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '24px' }}>
              <label htmlFor="password" style={{ display: 'block', color: '#374151', fontSize: '14px', fontWeight: '500', marginBottom: '8px' }}>
                Password
              </label>
              <input
                type="password"
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: '#C8A64D', border: 'none', borderRadius: '8px',
            ...
            {error && (
              <div style={{
                ...
                borderRadius: '8px', color: '#dc2626', fontSize: '14px', textAlign: 'center'
              }}>
                {error}
              </div>
            )}
          ...
          <div style={{ marginTop: '20px', textAlign: 'center' }}>
            <Link href="/forgot-password" style={{ color: '#C8A64D', fontSize: '14px', textDecoration: 'none', fontWeight: '500' }}>
              Forgot password?
            </Link>
          </div>
          ...
          <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #e5e7eb', textAlign: 'center', color: '#6b7280', fontSize: '14px' }}>
            ...
            <Link href="/register" style={{ color: '#C8A64D', textDecoration: 'none', fontWeight: '600' }}>
              Register here
            </Link>
          </div>
        </div>
