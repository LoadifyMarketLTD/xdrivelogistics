-- ================================================================
-- XDRIVE LOGISTICS LTD — FULL DATABASE SCHEMA
-- COPIAZĂ TOT ȘI RULEAZĂ ÎN SUPABASE → SQL EDITOR → RUN
-- (Copy everything and run in Supabase → SQL Editor → Run)
--
-- Conține TOATE tabelele, funcțiile și politicile RLS
-- necesare pentru funcționarea completă a site-ului.
...
-- ============================================================
-- 0b. SHARED UTILITY FUNCTION: auto-update updated_at
-- ============================================================
...
-- ============================================================
-- 3. RPC: create_company  (called from onboarding)
-- ============================================================
...
-- ============================================================
-- 4. USER SETTINGS  (per-user notification / alert preferences)
-- ============================================================
...
-- ============================================================
-- 5. USER ROLES  (named roles per user)
-- ============================================================
...
-- ============================================================
-- 7. VEHICLES  (fleet management — full extended schema)
-- ============================================================
...
-- ============================================================
-- 8. DRIVER LOCATIONS  (real-time GPS — upserted by mobile app)
-- ============================================================
...
-- ============================================================
-- 9. JOBS  (marketplace loads — full extended schema)
-- ============================================================
CREATE TABLE IF NOT EXISTS public.jobs (
  ...
  accepted_bid_id         UUID,   -- FK to job_bids added later
  -- Core locations
...
-- Ensure all extended columns exist even on pre-existing jobs tables
DO $$
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='jobs' AND column_name='current_status') THEN
    ALTER TABLE public.jobs ADD COLUMN current_status TEXT NOT NULL DEFAULT 'ALLOCATED'
      CHECK (current_status IN ('ALLOCATED','ON_MY_WAY_TO_PICKUP','ON_SITE_PICKUP','PICKED_UP','ON_MY_WAY_TO_DELIVERY','ON_SITE_DELIVERY','DELIVERED'));
  END IF;
...
-- ============================================================
-- 10. JOB BIDS  (marketplace bidding)
-- ============================================================
...
-- ============================================================
-- 11. JOB TRACKING EVENTS  (driver timeline — loads/[id] page)
-- ============================================================
...
-- ============================================================
-- 12. JOB STATUS EVENTS  (status change log — API route)
-- ============================================================
...
-- ============================================================
-- 13. JOB EVIDENCE  (photos, signatures, documents — API route)
-- ============================================================
...
-- ============================================================
-- 14. PROOF OF DELIVERY  (ePOD — loads/[id] page)
-- ============================================================
...
-- ============================================================
-- 15. JOB POD  (generated ePOD PDFs — API route)
-- ============================================================
...
-- ============================================================
-- 16. JOB DOCUMENTS  (CMR, invoices, etc — loads/[id] page)
-- ============================================================
...
-- ============================================================
-- 17. JOB NOTES  (internal / customer notes — loads/[id] page)
-- ============================================================
...
-- ============================================================
-- 18. INVOICES  (billing — invoices pages)
-- ============================================================
...
-- ============================================================
-- 20. HELPER: is_company_member(company_id)
-- ============================================================
...
-- ============================================================
-- 27. RLS POLICIES — driver_locations
-- ============================================================
...
-- ============================================================
-- 28. RLS POLICIES — jobs
-- ============================================================
DROP POLICY IF EXISTS "jobs_select" ON public.jobs;
CREATE POLICY "jobs_select" ON public.jobs FOR SELECT TO authenticated
  USING (
    -- open jobs visible to everyone (marketplace)
    status = 'open'
    -- or your company posted / was assigned
    ...
    -- or you are the assigned driver
...
-- ============================================================
-- 30. RLS POLICIES — job_tracking_events
-- ============================================================
...
-- ============================================================
-- 31. RLS POLICIES — job_status_events
-- ============================================================
...
-- ============================================================
-- 33. RLS POLICIES — proof_of_delivery
-- ============================================================
...
-- ============================================================
-- 38. HELPER RPC: get_user_company_id
-- ============================================================
...
-- ============================================================
-- 39. VERIFICATION — shows all tables created
-- ============================================================
SELECT
  table_name,
...
WHERE table_schema = 'public'
  ...
  AND table_name IN (
    'profiles','companies','user_settings','user_roles',
    'drivers','vehicles','driver_locations',
    'jobs','job_bids','job_tracking_events','job_status_events',
    'job_evidence','proof_of_delivery','job_pod',
